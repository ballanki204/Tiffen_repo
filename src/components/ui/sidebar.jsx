...
>(({ defaultOpen = true, open, onOpenChange, className, style, children, ...props }, ref) => {
  ...
  const setOpen = React.useCallback(
    (value | ((value) => boolean)) => {
      const openState =  === "function"  value(open) ;
      if (setOpenProp) {
  ...
  React.useEffect(() => {
    const handleKeyDown = (event) => {
      if (event.key === SIDEBAR_KEYBOARD_SHORTCUT && (event.metaKey |.ctrlKey)) {
...
const SidebarRail = React.forwardRef<HTMLButtonElement, React.>(
  ({ className, ...props }, ref) => {
    const { toggleSidebar } = useSidebar();
    ...
    return (
      <button
        ...
        className={cn(
          "absolute inset-y-0 z-20 hidden w-4 -translate-x-1/2 transition-all ease-linear after after-y-0 after-1/2 after:w-[2px] group-data-[side=left]:-right-4 group-data-[side=right]-0 hover-sidebar-border sm",
...
const SidebarInset = React.forwardRef<HTMLDivElement, React.>(({ className, ...props }, ref) => {
  return (
    <main
      ref={ref}
      className={cn(
...
const SidebarHeader = React.forwardRef<HTMLDivElement, React.>(({ className, ...props }, ref) => {
  return <div ref={ref} data-sidebar="header" className={cn("flex flex-col gap-2 p-2", className)} {...props} />;
});
SidebarHeader.displayName = "SidebarHeader";

const SidebarFooter = React.forwardRef<HTMLDivElement, React.>(({ className, ...props }, ref) => {
...
const SidebarContent = React.forwardRef<HTMLDivElement, React.>(({ className, ...props }, ref) => {
  return (
    <div
      ref={ref}
...
const SidebarGroup = React.forwardRef<HTMLDivElement, React.>(({ className, ...props }, ref) => {
  return (
    <div
      ref={ref}
      data-sidebar="group"
...
const SidebarGroupLabel = React.forwardRef<HTMLDivElement, React. & { asChild }>(
...
const SidebarGroupAction = React.forwardRef<HTMLButtonElement, React. & { asChild }>(
  ({ className, asChild = false, ...props }, ref) => {
...
const SidebarGroupContent = React.forwardRef<HTMLDivElement, React.>(
  ({ className, ...props }, ref) => (
...
const SidebarMenu = React.forwardRef<HTMLUListElement, React.>(({ className, ...props }, ref) => (
  <ul ref={ref} data-sidebar="menu" className={cn("flex w-full min-w-0 flex-col gap-1", className)} {...props} />
));
SidebarMenu.displayName = "SidebarMenu";

const SidebarMenuItem = React.forwardRef<HTMLLIElement, React.>(({ className, ...props }, ref) => (
...
const SidebarMenuBadge = React.forwardRef<HTMLDivElement, React.>(
  ({ className, ...props }, ref) => (
    <div
      ref={ref}
...
const SidebarMenuSub = React.forwardRef<HTMLUListElement, React.>(
  ({ className, ...props }, ref) => (
    <ul
      ref={ref}
...
const SidebarMenuSubItem = React.forwardRef<HTMLLIElement, React.>(({ ...props }, ref) => (
  <li ref={ref} {...props} />
));
